...
<div class="wrap ">
    <a href="{{ route('student.index') }}" class="btn btn-warning btn-sm">Back</a><br><br>
            ...
            <form action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @if( $errors->has('password'))
                        <br><p class="alert alert-danger">{{ $errors->first('password') }} <button class="close" data-dismiss="alert">&times;</button></p><br>

                    @endif
                </div>
                <div class="form-group">
                    <label for="">Class</label>
                    <input name="class"  value="{{old('class')}}" class="form-control" type="text">
                    @if( $errors->has('class'))
                        <br><p class="alert alert-danger">{{ $errors->first('class') }} <button class="close" data-dismiss="alert">&times;</button></p><br>
                ...
                <div class="form-group">
                    ...
                    @if($errors->has('photo'))
                        <br><p class="alert alert-danger">{{ $errors->first('photo') }} <button class="close" data-dismiss="alert">&times;</button></p><br>
